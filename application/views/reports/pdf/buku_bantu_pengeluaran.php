...
<div class="report-title-container">
    <h2 class="report-main-title">BUKU BANTU PENGELUARAN BARANG PERSEDIAAN</h2>
...
<table class="data-table">
    ...
    <tbody>
        ...
        <?php endforeach; else: ?>
        <tr><td colspan="8" style="text-align:center; color:#999; padding:20px;">Tidak ada data ditemukan untuk periode ini.</td></tr>
        <?php endif; ?>
    </tbody>
</table>
